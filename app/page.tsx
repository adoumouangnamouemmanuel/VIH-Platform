          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                Découvrez tous nos services conçus pour vous accompagner à
                chaque étape de votre parcours de dépistage.
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            >
              ...
              <p className="text-xl text-indigo-700/80">
                Découvrez les expériences de personnes qui ont utilisé notre
                plateforme.
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            >
              ...
              <p className="text-xl md:text-2xl mb-10 text-white/90">
                Le dépistage précoce du VIH permet une prise en charge rapide et
                efficace. Notre plateforme vous accompagne à chaque étape de
                votre parcours.
              </p>
