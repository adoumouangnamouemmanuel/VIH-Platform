          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Suivez vos résultats de dépistage et gérez vos rendez-vous en
                ...
                <Card className="border-0 shadow-lg dark:shadow-indigo-900/10 bg-gradient-to-br from-indigo-600 to-violet-600 text-white">
                  <CardContent className="p-6 flex flex-col items-center justify-center h-full">
                    ...
                    <p className="text-sm text-center text-white/80 mb-4">
                      Toutes vos données sont chiffrées et protégées. Seul vous
                      pouvez y accéder.
                    </p>
                    <Button
                      variant="outline"
                  ...
                  >
                    <Card className="border-0 shadow-lg dark:shadow-indigo-900/10">
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription>
                          Consultez l'historique de vos tests de dépistage et
                        ...
                        {testResults.length > 0 ? (
                          ...
                          <div className="text-center py-12">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                              Vous n'avez pas encore de résultats de dépistage.
                              Prenez rendez-vous dans un centre pour effectuer
                              un test.
                            </p>
                            <Button
                              asChild
                  ...
                  >
                    <Card className="border-0 shadow-lg dark:shadow-indigo-900/10">
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription>
                          Consultez et gérez vos rendez-vous de dépistage et de
                          suivi.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        {appointments.length > 0 ? (
                          ...
                          <div className="text-center py-12">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                              Vous n'avez pas de rendez-vous programmés. Prenez
                              rendez-vous dans un centre pour effectuer un test.
                            </p>
                            <Button
                              asChild
                              className="rounded-full bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700"
                  ...
                  >
                    <Card className="border-0 shadow-lg dark:shadow-indigo-900/10">
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription>
                          Restez informé des mises à jour concernant vos
                        ...
                        {notifications.length > 0 ? (
                          ...
                          <div className="text-center py-12">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                              ...
                              Nous vous informerons des mises à jour
                              importantes.
                            </p>
                          </div>
                        )}
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                              Sécuriser votre compte avec une vérification
                              supplémentaire
                            </p>
                          </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                              Utiliser votre empreinte digitale ou
                  ...
                  <div className="pt-4 border-t border-gray-200 dark:border-gray-800">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                        Votre compte est bien sécurisé. Pour une sécurité
                        optimale, activez toutes les options de sécurité.
                      </p>
                    </div>
                  </div>
                </CardContent>
