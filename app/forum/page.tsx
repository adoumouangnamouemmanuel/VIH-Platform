          ...
          >
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Échangez anonymement avec d'autres utilisateurs et posez vos
                questions dans un espace sécurisé et bienveillant.
              </p>
            </div>
              ...
              >
                <Alert className="mb-8 border-0 shadow-lg dark:shadow-indigo-900/10 bg-gradient-to-r from-indigo-50 to-violet-50 dark:from-indigo-950/30 dark:to-violet-950/30 border-l-4 border-l-indigo-500">
                  ...
                  <AlertDescription className="text-gray-700 dark:text-gray-300">
                    Ce forum est modéré par des professionnels de santé. Les
                    informations partagées sont vérifiées, mais consultez
                    toujours un médecin pour des conseils personnalisés. Votre
                      ...
                      <Card className="border-0 shadow-lg dark:shadow-indigo-900/10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
                        <CardContent className="flex flex-col items-center justify-center py-16">
                          ...
                          <p className="text-gray-600 dark:text-gray-400 text-center mb-8 max-w-md">
                            ...
                            Essayez d'autres termes ou créez une nouvelle
                            discussion.
                          </p>
                          <Button
                            onClick={() => setShowNewPostModal(true)}
                  ...
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                    <Card className="border-0 shadow-lg dark:shadow-indigo-900/10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
                      <CardContent className="flex flex-col items-center justify-center py-16">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-center mb-8 max-w-md">
                          Cette section affichera bientôt les discussions les
                          plus populaires de la communauté.
                        </p>
                      </CardContent>
                    </Card>
                  </motion.div>
                  ...
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                    <Card className="border-0 shadow-lg dark:shadow-indigo-900/10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
                      <CardContent className="flex flex-col items-center justify-center py-16">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-center mb-8 max-w-md">
                          Aidez la communauté en répondant aux questions qui
                ...
                <Card className="border-0 shadow-2xl bg-white dark:bg-gray-900 overflow-hidden">
                  ...
                  <CardFooter className="flex justify-between border-t p-6 bg-gray-50 dark:bg-gray-900">
                    <p className="text-sm text-gray-500 dark:text-gray-400 flex items-center">
                      ...
                      Votre anonymat est garanti. Aucune information personnelle
                      n'est partagée.
                    </p>
