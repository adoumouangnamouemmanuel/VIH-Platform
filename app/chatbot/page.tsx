        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-8">
              Posez vos questions sur le VIH, le dépistage et la prévention au Niger. Amina est là pour vous aider
              24h/24.
            </p>
              ...
              >
                <Card className="border-0 shadow-lg dark:shadow-indigo-900/10 hover:shadow-xl transition-all duration-300 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">{action.label}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      {action.label === "Centres Niamey" && "Trouvez les centres de dépistage à Niamey"}
                      {action.label === "Urgence" && "Numéros d'urgence VIH au Niger"}
                      {action.label === "PrEP" && "Informations sur la prophylaxie pré-exposition"}
                      {action.label === "Soutien" && "Soutien psychologique et associations"}
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
            ...
            <Card className="border-0 shadow-lg dark:shadow-indigo-900/10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100">Urgence VIH</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-3">Ligne d'urgence gratuite 24h/24</p>
                <p className="font-bold text-lg text-green-600 dark:text-green-400">15 15</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg dark:shadow-indigo-900/10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100">Tests Gratuits</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-3">Dépistage gratuit dans tout le Niger</p>
                <p className="font-bold text-lg text-blue-600 dark:text-blue-400">100% Gratuit</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg dark:shadow-indigo-900/10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100">Résultats Rapides</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-3">Tests rapides disponibles</p>
                <p className="font-bold text-lg text-purple-600 dark:text-purple-400">15-30 min</p>
              </CardContent>
            </Card>
          </div>
        </motion.div>
        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              style={{ width: isMinimized ? 80 : 400, height: isMinimized ? 60 : 600 }}
            >
              {/* Header */}
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Avatar className="h-8 w-8 ring-2 ring-white/30">
                      <AvatarImage src="/placeholder.svg?height=32&width=32" alt="Amina" />
                      <AvatarFallback className="bg-white/20 text-white font-bold text-sm">A</AvatarFallback>
                    </Avatar>
                    <motion.div
                  ...
                  {!isMinimized && (
                    <div>
                      ...
                      <p className="text-xs text-white/80">Assistant VIH Niger</p>
                    </div>
                  )}
                </div>
                          ...
                          <div className="flex items-start max-w-[85%] gap-2">
                            {message.sender === "bot" && (
                              <Avatar className="h-6 w-6 ring-1 ring-indigo-100 dark:ring-indigo-800">
                                <AvatarImage src="/placeholder.svg?height=24&width=24" alt="Amina" />
