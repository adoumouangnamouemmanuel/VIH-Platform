        ...
        <div className="container mx-auto">
          ...
          <section id="hero" className="mb-20">
            ...
            >
              ...
              >
                Découvrez tout ce que vous devez savoir sur le VIH à travers une expérience d'apprentissage moderne,
                interactive et bienveillante. Informez-vous, testez vos connaissances et devenez acteur de la
                prévention.
              </motion.p>
          ...
          <section id="understanding" className="mb-20">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                Une approche moderne et interactive pour apprendre les bases du VIH
              </p>
            </motion.div>
                ...
                >
                  <Card className="border-0 shadow-2xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg overflow-hidden">
                    <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-violet-600 text-white p-8">
                      ...
                      <p className="text-white/80 text-lg">Comprendre le virus de l'immunodéficience humaine</p>
                    </div>
                    <CardContent className="p-8 space-y-8">
                        ...
                        <div className="space-y-6">
                          ...
                          >
                            ...
                            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                              Le VIH (Virus de l'Immunodéficience Humaine) est un virus qui attaque le système
                              immunitaire, affaiblissant la capacité du corps à combattre les infections et certaines
                              maladies.
                            </p>
                          </motion.div>
                          ...
                          >
                            ...
                            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                              Avec les traitements actuels, une personne séropositive peut vivre une vie normale et en
                              bonne santé, avec une espérance de vie similaire à celle de la population générale.
                            </p>
                          </motion.div>
                        </div>
                        ...
                        >
                          ...
                          <div className="space-y-4">
                            <div className="flex items-center gap-3">
                              ...
                              <span className="text-gray-700 dark:text-gray-300">Infection initiale</span>
                            </div>
                            <div className="flex items-center gap-3">
                              <div className="w-3 h-3 rounded-full bg-orange-400"></div>
                              <span className="text-gray-700 dark:text-gray-300">Phase asymptomatique</span>
                            </div>
                            <div className="flex items-center gap-3">
                              <div className="w-3 h-3 rounded-full bg-red-400"></div>
                              <span className="text-gray-700 dark:text-gray-300">SIDA (sans traitement)</span>
                            </div>
                          </div>
                          <div className="mt-6 p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl">
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                              💡 <strong>Important :</strong> Avec un traitement approprié, l'évolution vers le SIDA
                              peut être évitée.
                            </p>
                          </div>
                        </motion.div>
                      ...
                      <Alert className="border-0 bg-gradient-to-r from-indigo-50 to-violet-50 dark:from-indigo-950/30 dark:to-violet-950/30 border-l-4 border-l-indigo-500">
                        ...
                        <AlertTitle className="text-indigo-800 dark:text-indigo-300">Concept I=I</AlertTitle>
                        <AlertDescription className="text-gray-700 dark:text-gray-300">
                          Une personne séropositive sous traitement efficace avec une charge virale indétectable ne
                          transmet pas le VIH. C'est ce qu'on appelle le concept "I=I" (Indétectable = Intransmissible).
                        </AlertDescription>
                      </Alert>
                    </CardContent>
                  </Card>
                ...
                >
                  <Card className="border-0 shadow-2xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg overflow-hidden">
                    <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white p-8">
                      ...
                      <p className="text-white/80 text-lg">Comment se protéger et protéger les autres</p>
                    </div>
                    <CardContent className="p-8">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {[
                          {
                            title: "Préservatifs",
                            description: "Utilisez des préservatifs lors de chaque rapport sexuel",
                            icon: Shield,
                            color: "blue",
                          },
                          {
                            title: "PrEP",
                            description: "Traitement préventif pour les personnes à haut risque",
                            icon: Stethoscope,
                            color: "purple",
                          },
                          {
                            title: "TPE",
                            description: "Traitement d'urgence dans les 48h après exposition",
                            icon: AlertCircle,
                            color: "orange",
                          },
                          {
                            title: "Dépistage régulier",
                            description: "Connaître son statut permet de prendre les mesures appropriées",
                            icon: Heart,
                            color: "green",
                          },
                        ].map((item, index) => (
                ...
                >
                  <Card className="border-0 shadow-2xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg overflow-hidden">
                    <div className="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white p-8">
                      ...
                      <p className="text-white/80 text-lg">Les avancées médicales qui changent tout</p>
                    </div>
                    <CardContent className="p-8 space-y-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                          ...
                          >
                            ...
                            <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">{stat.title}</h4>
                      ...
                      <Alert className="border-0 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border-l-4 border-l-green-500">
                        ...
                        <AlertTitle className="text-green-800 dark:text-green-300">Message d'espoir</AlertTitle>
                        <AlertDescription className="text-gray-700 dark:text-gray-300">
                          Grâce aux traitements antirétroviraux modernes, une personne diagnostiquée séropositive
                          aujourd'hui peut vivre une vie longue, saine et épanouie. Le plus important est de commencer
                          le traitement rapidement après le diagnostic.
                        </AlertDescription>
                      </Alert>
                    </CardContent>
                  </Card>
                    ...
                    <motion.div key={index} variants={fadeInUp}>
                      <Card
                        className={`border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 overflow-hidden group ${
                          video.featured ? "ring-2 ring-indigo-500 dark:ring-indigo-400" : ""
                        }`}
                      >
                  ...
                  {[
                    {
                      ...
                      description: "Tout savoir sur les différents tests disponibles et leur fiabilité",
                      icon: FileText,
                      size: "2.4 MB",
                      pages: "24 pages",
                    },
                    {
                      ...
                      description: "Les moyens de prévention expliqués simplement avec illustrations",
                      icon: Shield,
                      size: "1.8 MB",
                      pages: "16 pages",
                    },
                        ...
                        <CardContent className="p-8">
                          <div className="flex items-start gap-6">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">{doc.description}</p>
                    ...
                    <motion.div key={index} variants={fadeInUp}>
                      <Card
                        className={`border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 h-full overflow-hidden ${
                          testimonial.featured ? "ring-2 ring-purple-500 dark:ring-purple-400" : ""
                        }`}
                      >
                        <div
                          className={`${
                          ...
                          <div className="flex items-center gap-3">
                            <motion.div
                              ...
                              className={`rounded-full p-3 ${
                                testimonial.featured ? "bg-white/20" : "bg-indigo-100 dark:bg-indigo-900/30"
                              }`}
                            >
                              <Users
                                className={`h-6 w-6 ${
                                  testimonial.featured ? "text-white" : "text-indigo-600 dark:text-indigo-400"
                                }`}
                              />
                            </motion.div>
                            <div>
                              <h3
                                className={`text-lg font-bold ${
                                  testimonial.featured ? "text-white" : "text-gray-900 dark:text-gray-100"
                                }`}
                              >
                                {testimonial.title}
                              </h3>
                              <p
                                className={`${
                                  testimonial.featured ? "text-white/80" : "text-gray-600 dark:text-gray-400"
                                }`}
                              >
                                {testimonial.name}
                              </p>
              ...
              <Card className="border-0 shadow-2xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg overflow-hidden">
                <CardContent className="p-8">
                  <Accordion type="single" collapsible className="w-full space-y-4">
                    {[
                      {
                        question: "Combien de temps après une exposition peut-on détecter le VIH ?",
                        answer:
                ...
                <CardContent className="p-12 relative z-10">
                  <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                      ...
                      <span className="font-medium">Vous avez des questions ?</span>
                    </motion.div>
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">Besoin d'aide personnalisée ?</h2>
                    <p className="text-xl md:text-2xl mb-10 text-white/90 max-w-3xl mx-auto">
                      Notre assistant virtuel peut vous aider à trouver des réponses à vos questions et vous orienter
