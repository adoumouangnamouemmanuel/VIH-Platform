        ...
        <div className="container mx-auto relative">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Découvrez les centres de dépistage VIH dans toutes les régions du
              Niger.
              <span className="text-indigo-600 dark:text-indigo-400 font-medium">
                {" "}
                Confidentialité garantie
              </span>
              , prise en charge professionnelle et résultats fiables.
            </p>
          </motion.div>
            ...
            <TabsContent value="map" className="mt-0">
              ...
              {selectedCentre && (
                ...
                >
                  <CentreCard
                    centre={
                      filteredCentres.find((c) => c.id === selectedCentre)!
                    }
                    index={0}
                  />
                </motion.div>
                  ...
                  <Card className="border-0 shadow-xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl">
                    <CardContent className="flex flex-col items-center justify-center py-16">
                      ...
                      <p className="text-gray-500 dark:text-gray-400 text-center mb-8 max-w-md leading-relaxed">
                        Aucun centre ne correspond à votre recherche. Essayez de
                        rechercher dans une autre région du Niger.
                      </p>
                      <Button
                ...
                <div className="flex flex-col lg:flex-row items-center gap-8">
                  <div className="lg:w-2/3 text-center lg:text-left">
                    <h2 className="text-3xl font-bold mb-4">
                      Besoin d'aide pour choisir un centre ?
                    </h2>
                    <p className="text-xl opacity-90 leading-relaxed">
                      Notre assistant virtuel peut vous aider à trouver le
                      centre le plus proche de votre région, répondre à vos
                      questions sur le dépistage et vous orienter vers les
                      services adaptés au Niger.
                    </p>
                  </div>
