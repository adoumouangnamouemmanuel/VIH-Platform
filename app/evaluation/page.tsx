...
const questions = [
  {
    id: 1,
    question:
      "Avez-vous eu des rapports sexuels non protégés au cours des 3 derniers mois ?",
    options: [
  ...
  },
  {
    id: 2,
    question:
      "Avez-vous eu de la fièvre, des maux de gorge, des ganglions enflés ou une éruption cutanée récemment ?",
    options: [
  ...
  },
  {
    id: 3,
    question:
      "Avez-vous partagé du matériel d'injection (aiguilles, seringues) ?",
    options: [
  ...
  },
  {
    id: 4,
    question:
      "Avez-vous eu des partenaires sexuels multiples au cours des 6 derniers mois ?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      "Avez-vous déjà été diagnostiqué avec une autre infection sexuellement transmissible ?",
    options: [
        ...
        <div className="relative z-10 pt-24 pb-16 px-4">
          <div className="container mx-auto max-w-4xl">
            ...
            >
              ...
              >
                Un questionnaire confidentiel et sécurisé pour évaluer votre
                risque potentiel d'exposition au VIH. Vos réponses ne sont
                jamais enregistrées.
              </motion.p>
            </motion.div>
